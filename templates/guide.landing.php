				...
				<div class="row">
					...
					<div class="col-md-5">
						...
						<div class="list-options btn-group ">
							...
							<a href="/guides/{{guide.slug}}/{{book.slug}}/{{book.children[0].slug}}" class="btn btn-default title-btn">
					...
					<div class="col-md-4">
						<div class="book-casing panel panel-default">
							...
							<div class="panel-body">
								...
								<p>time: <strong>{{book.time}}</strong></p>
								<hr>
								<a href="/guides/{{guide.slug}}/{{book.slug}}" class="btn btn-primary btn-lg btn-block">Start</a>
