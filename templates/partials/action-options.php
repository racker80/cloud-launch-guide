<div class="action-options btn-group btn-group-sm">
	{% if allsteps %}
	    <a href="{{ baseurl }}/guides/{{guide.slug}}/{{book.slug}}" class="btn btn-default btn-info-rs allSteps allStepsOn"><span class="glyphicon glyphicon-th-list"></span>All Chapters</a>
	{% else %}
		<a href="{{ baseurl }}/guides/{{guide.slug}}/{{book.slug}}{{chapterslug}}" class="btn btn-default allSteps"><span class="glyphicon glyphicon-th-list"></span>All Chapters</a>
	{% endif %}
	    
	<button type="button" data-toggle-expert class="btn btn-default tooltip-rs" title="Toggle imformative content"><span class="glyphicon glyphicon-certificate"></span>Expert Mode</button>
