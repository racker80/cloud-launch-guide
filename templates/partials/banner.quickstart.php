<div id="banner-wrapper" class="quickstart-wrapper">
	<div class="container quickstart">
		<a href="" class="glyphicon glyphicon-remove quickstart-close"></a>
		<div class="row">
			<div class="col-md-2">
				<a href="##" class="video-launch tooltip-rs dialog-rs" data-toggle="modal" data-target="" title="Watch the Quick Start Guide video."></a>
			</div>
